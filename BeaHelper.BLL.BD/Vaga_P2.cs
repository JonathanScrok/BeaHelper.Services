...
namespace BeaHelper.BLL.BD
{
    public class Vaga_P2 {
        ...
        #region Consultas
        private const string SELECT_EVENTORECORRENTE = @"select Id_Vaga from helper.Vagas WHERE EventoRecorrente = 1 AND DataEvento < GetDate();";
        #endregion
        ...
        #region Eventos Recorrentes
        public static List<Vaga> EVENTOS_RECORRENTES()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(SELECT_EVENTORECORRENTE, conn);
